...
public class MainController {
    MethodControl methodControl = new MethodControl();
    PrintInfo printInfo = new PrintInfo(methodControl);
    private ReadDataFromUser dataReader = new ReadDataFromUser(printInfo);

//    String checkBy = dataReader.checkByYearOrDecade();
//    int yearFromUser = dataReader.getYearFromUser();
//    String fileName = methodControl.getFileNameFromUser();
        ...
        do {
            ...
            switch (option) {
                case ALL_BABIES_FROM_FILE:
                    List<Baby> babies = methodControl.getAllBabiesFromFile();
                    printInfo.printAllBabiesFromFile(babies);
                    break;
                case NUMBER_OF_ALL_BABIES_NAMES_FROM_FILE:
                    babies = methodControl.getAllBabiesFromFile();
                    methodControl.getNoOfAllNamesFromFile(babies);
                    printInfo.printNoOfAllNamesFromFile(babies);
                    break;
                case NUMBER_OF_ALL_BABIES_FROM_FILE:
                    babies = methodControl.getAllBabiesFromFile();
                    methodControl.getNoOfAllBabiesFromFile(babies);
                ...
                case WHAT_NAME_IN_ANOTHER_YEAR:
                    ...
                    gender = dataReader.getGenderFromUser();
                    String newName = methodControl.whatIsNameInYear(name, year, newYear, gender);
                    printInfo.printWhatIsNameInYear(name, year, newYear, gender, newName);
                    break;
